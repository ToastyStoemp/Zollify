/**
 * Swiss customs tariff (HS) codes a booth is likely to declare, with the duty
 * and VAT rate each carries and whether a permit is involved. Verbatim from
 * the legacy customs tool; the product editor looks codes up here and the
 * customs module derives rates from them.
 */
